      ...
      <ol className="flex flex-col lg:flex-row relative lg:border-l border-[#a39a8f]">
        <li className="mb-10 lg:ml-10 -mt-2">
          ...
          <div className="flex flex-col lg:flex-row mt-4">
            <div className="relative flex justify-center lg:max-w-[750px] lg:max-h-[450px] hover:drop-shadow-[0_25px_35px_rgba(0,0,0,0.3)] duration-200 ease-in-out">
              <a href={link} target="_blank">
                <img
                  src={image}
                  className=" aspect-video lg:max-w-[750px] lg:max-h-[450px] object-cover border-8 border-[#a39a8f] rounded-2xl "
                  alt={title}
                />
              </a>
            </div>
